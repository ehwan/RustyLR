...
impl EContext {
    ...
    pub fn feed(&mut self, term: char) -> Result<(), EParseError> {
    ...
    pub fn accept(
        ...
        (f32, <EData as ::rusty_lr::parser::semantic_value::SemanticValue>::UserData),
        EParseError,
    > {
        self.inner.feed_eof()?;
...
impl EData {
    fn __rustylr_into_start_0(value: Self) -> Option<f32> {
        match value {
            Self::__variant2(val) => Some(val),
            _ => None,
        }
    }
    ///Digit -> '0'
