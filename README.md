...
***A Bison-like parser generator & compiler frontend framework for Rust supporting IELR(1), LALR(1) parser tables, with deterministic LR and non-deterministic LR (GLR) parsing.***
