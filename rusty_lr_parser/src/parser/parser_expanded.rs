// This file was generated by rustylr 1.1.4
//
...
impl std::fmt::Display for GrammarNonTerminals {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            GrammarNonTerminals::_GrammarLinePlus39 => write!(f, "{}", "GrammarLine+"),
...
impl ::rusty_lr_core::NonTerminal<Lexed> for GrammarNonTerminals {
    fn is_auto_generated(&self) -> bool {
        match self {
            ...
            GrammarNonTerminals::_GrammarLinePlus39 => true,
    ...
    fn is_augmented(&self) -> bool {
        match self {
            ...
            GrammarNonTerminals::_GrammarLinePlus39 => false,
            GrammarNonTerminals::Augmented => true,
        }
    }
}
...
impl GrammarStack {
    ...
    fn reduce__GrammarLinePlus39_0(
        &mut self,
        lookahead: &Lexed,
        data: &mut GrammarArgs,
    ) -> Result<(), ::rusty_lr_core::DefaultReduceActionError> {
    ...
    fn reduce__GrammarLinePlus39_1(
        &mut self,
        lookahead: &Lexed,
        data: &mut GrammarArgs,
    ) -> Result<(), ::rusty_lr_core::DefaultReduceActionError> {
...
impl ::rusty_lr_core::lr::Stack for GrammarStack {
    ...
    fn reduce(
        ...
        match rustylr_macro_generated_ruleid__ {
            ...
            46usize => self.reduce_Dense_0(lookahead, user_data),
            ...
            62usize => self.reduce__TokenMappedPlus29_0(lookahead, user_data),
            63usize => self.reduce__TokenMappedPlus29_1(lookahead, user_data),
            64usize => self.reduce__TokenMappedStar30_0(lookahead, user_data),
            65usize => self.reduce__TokenMappedStar30_1(lookahead, user_data),
            66usize => self.reduce__PrecDefQuestion31_0(lookahead, user_data),
            67usize => self.reduce__PrecDefQuestion31_1(lookahead, user_data),
            68usize => self.reduce__caretQuestion32_0(lookahead, user_data),
            69usize => self.reduce__caretQuestion32_1(lookahead, user_data),
            70usize => self.reduce__TerminalSetItemPlus33_0(lookahead, user_data),
            71usize => self.reduce__TerminalSetItemPlus33_1(lookahead, user_data),
            72usize => self.reduce__TerminalSetItemStar34_0(lookahead, user_data),
            73usize => self.reduce__TerminalSetItemStar34_1(lookahead, user_data),
            74usize => self.reduce__PatternPlus35_0(lookahead, user_data),
            75usize => self.reduce__PatternPlus35_1(lookahead, user_data),
            76usize => self.reduce__TermSet36_0(lookahead, user_data),
            77usize => self.reduce__TermSet36_1(lookahead, user_data),
            78usize => self.reduce__TermSet36_2(lookahead, user_data),
            79usize => self.reduce__TermSet36_3(lookahead, user_data),
            80usize => self.reduce__TermSet36_4(lookahead, user_data),
            81usize => self.reduce__TermSet36_5(lookahead, user_data),
            82usize => self.reduce__TermSet36_6(lookahead, user_data),
            83usize => self.reduce__TermSet36_7(lookahead, user_data),
            84usize => self.reduce__TermSet36_8(lookahead, user_data),
            85usize => self.reduce__TermSet36_9(lookahead, user_data),
            86usize => self.reduce__TermSet36_10(lookahead, user_data),
            87usize => self.reduce__TermSet36_11(lookahead, user_data),
            88usize => self.reduce__TermSet36_12(lookahead, user_data),
            89usize => self.reduce__TermSet36_13(lookahead, user_data),
            90usize => self.reduce__TermSet36_14(lookahead, user_data),
            91usize => self.reduce__TermSet36_15(lookahead, user_data),
            92usize => self.reduce__TermSet36_16(lookahead, user_data),
            93usize => self.reduce__TermSet36_17(lookahead, user_data),
            94usize => self.reduce__TermSet36_18(lookahead, user_data),
            95usize => self.reduce__TermSet36_19(lookahead, user_data),
            96usize => self.reduce__TermSet36_20(lookahead, user_data),
            97usize => self.reduce__TermSet36_21(lookahead, user_data),
            98usize => self.reduce__TermSet36_22(lookahead, user_data),
            99usize => self.reduce__TermSet36_23(lookahead, user_data),
            100usize => self.reduce__TermSet36_24(lookahead, user_data),
            101usize => self.reduce__TermSet36_25(lookahead, user_data),
            102usize => self.reduce__TermSet36_26(lookahead, user_data),
            103usize => self.reduce__TermSet36_27(lookahead, user_data),
            104usize => self.reduce__TermSet36_28(lookahead, user_data),
            105usize => self.reduce__TermSet36_29(lookahead, user_data),
            106usize => self.reduce__TermSet36_30(lookahead, user_data),
            107usize => self.reduce__TermSet36_31(lookahead, user_data),
            108usize => self.reduce__TermSet36_32(lookahead, user_data),
            109usize => self.reduce__TermSet36_33(lookahead, user_data),
            ...
            114usize => self.reduce__GrammarLinePlus39_0(lookahead, user_data),
            115usize => self.reduce__GrammarLinePlus39_1(lookahead, user_data),
            116usize => self.reduce_Augmented_0(lookahead, user_data),
            _ => {
...
impl GrammarParser {
    ...
    pub fn new() -> Self {
        ...
        builder.add_rule(
            ...
            vec![::rusty_lr_core::Token::NonTerm(
                GrammarNonTerminals::_GrammarLinePlus39,
            )],
            None,
            None,
        );
        ...
        builder.add_rule(
            ...
            vec![
                ...
                ::rusty_lr_core::Token::NonTerm(GrammarNonTerminals::_GrammarLinePlus39),
            ],
            None,
            None,
        );
        ...
        terminals_class_map.insert(Lexed::Colon(punct!(':')), 30usize);
        terminals_class_map.insert(Lexed::Semicolon(punct!(';')), 34usize);
        terminals_class_map.insert(Lexed::Pipe(punct!('|')), 5usize);
        terminals_class_map.insert(Lexed::Equal(punct!('=')), 31usize);
        ...
        terminals_class_map.insert(Lexed::Caret(punct!('^')), 32usize);
        ...
        terminals_class_map.insert(Lexed::ParenGroup(None), 33usize);
        ...
        terminals_class_map.insert(Lexed::Eof, 35usize);
