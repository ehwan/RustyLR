// This file was generated by rustylr 0.14.0
//
...
impl GrammarParser {
    ...
    pub fn new() -> Self {
        ...
        const RUSTYLR_SHIFT_TERM_MAP: &[&[(u8, u8)]] = &[
            ...
            &[],
            &[],
            &[(0, 52), (19, 57), (20, 69), (23, 53)],
            &[],
            &[(6, 60), (7, 66), (8, 61), (11, 59), (12, 62)],
            &[(0, 52), (19, 57), (20, 72), (23, 53)],
            &[],
            &[(6, 75), (7, 81), (8, 76), (11, 74), (12, 77)],
            &[],
            &[],
            &[],
            &[(0, 78), (23, 40)],
        ...
        const RUSTYLR_SHIFT_NONTERM_MAP: &[&[(GrammarNonTerminals, u8)]] = &[
            &[
                (GrammarNonTerminals::DeriveDef, 116),
                (GrammarNonTerminals::EofDef, 117),
                (GrammarNonTerminals::ErrorDef, 118),
                (GrammarNonTerminals::Glr, 119),
                (GrammarNonTerminals::Grammar, 120),
                (GrammarNonTerminals::GrammarLine, 122),
                (GrammarNonTerminals::ModulePrefixDef, 123),
                (GrammarNonTerminals::ReduceDef, 124),
                (GrammarNonTerminals::ReduceType, 125),
                (GrammarNonTerminals::Rule, 134),
                (GrammarNonTerminals::StartDef, 135),
                (GrammarNonTerminals::TokenDef, 136),
                (GrammarNonTerminals::TokenTypeDef, 137),
                (GrammarNonTerminals::UserDataDef, 138),
                (GrammarNonTerminals::_GrammarLine_Plus8, 140),
            ],
            &[
            ...
            &[],
            &[
                (GrammarNonTerminals::RustCode, 29),
                (GrammarNonTerminals::_TerminalSet6, 22),
                (GrammarNonTerminals::__TerminalSet6_Plus7, 23),
            ],
            &[],
            ...
            &[],
            &[],
            &[(GrammarNonTerminals::RuleType, 35)],
            &[],
            &[],
            &[
                (GrammarNonTerminals::Pattern, 83),
                (GrammarNonTerminals::RuleLine, 84),
                (GrammarNonTerminals::RuleLines, 85),
                (GrammarNonTerminals::TerminalSet, 82),
                (GrammarNonTerminals::TokenMapped, 88),
                (GrammarNonTerminals::_TokenMapped_Plus0, 89),
                (GrammarNonTerminals::_TokenMapped_Star1, 91),
            ],
            &[],
            &[
                (GrammarNonTerminals::Pattern, 73),
                (GrammarNonTerminals::TerminalSet, 82),
            ],
            &[],
            &[(GrammarNonTerminals::_caret_Option2, 42)],
            &[],
            &[
                (GrammarNonTerminals::TerminalSetItem, 46),
                (GrammarNonTerminals::_TerminalSetItem_Plus3, 47),
                (GrammarNonTerminals::_TerminalSetItem_Star4, 49),
            ],
            &[],
            &[],
            &[],
            &[],
            &[(GrammarNonTerminals::TerminalSetItem, 48)],
            &[],
            &[],
            &[],
            &[
                (GrammarNonTerminals::Pattern, 58),
                (GrammarNonTerminals::TerminalSet, 67),
                (GrammarNonTerminals::_Pattern_Plus5, 71),
            ],
            &[],
            &[(GrammarNonTerminals::_caret_Option2, 54)],
            &[
                (GrammarNonTerminals::TerminalSetItem, 46),
                (GrammarNonTerminals::_TerminalSetItem_Plus3, 47),
                (GrammarNonTerminals::_TerminalSetItem_Star4, 55),
            ],
            &[],
            &[],
            &[
            ...
            &[
                ...
                (GrammarNonTerminals::TerminalSetOrIdent, 65),
            ],
            &[],
            &[],
            &[],
            ...
            &[
                ...
                (GrammarNonTerminals::TerminalSetOrIdent, 80),
            ],
            &[],
            &[],
            &[],
            ...
            &[
                (GrammarNonTerminals::Pattern, 83),
                (GrammarNonTerminals::RuleLine, 87),
                (GrammarNonTerminals::TerminalSet, 82),
                (GrammarNonTerminals::TokenMapped, 88),
                (GrammarNonTerminals::_TokenMapped_Plus0, 89),
                (GrammarNonTerminals::_TokenMapped_Star1, 91),
            ...
            &[
                (GrammarNonTerminals::Pattern, 83),
                (GrammarNonTerminals::TerminalSet, 82),
                (GrammarNonTerminals::TokenMapped, 90),
            ],
            &[],
            &[(GrammarNonTerminals::RuleId, 94)],
            &[],
            &[],
            &[(GrammarNonTerminals::Action, 96)],
            &[],
            &[],
            &[],
            &[],
            ...
            &[],
            &[
                (GrammarNonTerminals::RustCode, 114),
                (GrammarNonTerminals::_TerminalSet6, 22),
                (GrammarNonTerminals::__TerminalSet6_Plus7, 23),
            ],
            &[],
            ...
            &[
                ...
                (GrammarNonTerminals::TokenTypeDef, 137),
                (GrammarNonTerminals::UserDataDef, 138),
                (GrammarNonTerminals::_GrammarLine_Plus8, 139),
            ],
            &[],
            &[],
            &[
                (GrammarNonTerminals::TerminalSet, 131),
                (GrammarNonTerminals::TerminalSetOrIdent, 132),
            ],
            &[],
            &[(GrammarNonTerminals::_caret_Option2, 128)],
            &[
                (GrammarNonTerminals::TerminalSetItem, 46),
                (GrammarNonTerminals::_TerminalSetItem_Plus3, 47),
                (GrammarNonTerminals::_TerminalSetItem_Star4, 129),
            ],
            &[],
            &[],
            &[],
        ...
        const RUSTYLR_RULESET_SHIFTED0_MAP: &[u8] = &[
            0, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 3, 2, 1, 2, 2, 1,
            2, 2, 2, 2, 4, 2, 2, 5, 2, 6, 2, 7, 2, 8, 2, 2, 2, 2, 9, 2, 2, 2, 10, 2, 7, 8, 2, 2,
            10, 2, 2, 2, 2, 11, 2, 2, 2, 2, 2, 6, 2, 2, 6, 2, 2, 2, 2, 2, 11, 2, 2, 2, 2, 2, 2, 2,
            2, 12, 2, 2, 13, 2, 14, 2, 2, 15, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 2, 1, 2, 2, 1, 2, 2,
            1, 2, 2, 2, 2, 2, 2, 2, 2, 16, 2, 2, 11, 2, 7, 8, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,
        ];
