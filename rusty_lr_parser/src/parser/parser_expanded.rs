// This file was generated by rustylr 0.12.0
//
...
impl ::rusty_lr_core::lr::Context for GrammarContext {
    ...
    fn reduce(
        ...
        match rustylr_macro_generated_ruleid__ {
            ...
            67usize => self.reduce_DeriveDef_0(lookahead, data),
            68usize => self.reduce_GrammarLine_0(lookahead, data),
            69usize => self.reduce_GrammarLine_1(lookahead, data),
            70usize => self.reduce_GrammarLine_2(lookahead, data),
            71usize => self.reduce_GrammarLine_3(lookahead, data),
            72usize => self.reduce_GrammarLine_4(lookahead, data),
            73usize => self.reduce_GrammarLine_5(lookahead, data),
            74usize => self.reduce_GrammarLine_6(lookahead, data),
            75usize => self.reduce_GrammarLine_7(lookahead, data),
            76usize => self.reduce_GrammarLine_8(lookahead, data),
            77usize => self.reduce_GrammarLine_9(lookahead, data),
            78usize => self.reduce_GrammarLine_10(lookahead, data),
...
impl GrammarParser {
    ...
    pub fn new() -> Self {
        ...
        const RUSTYLR_SHIFT_NONTERM_MAP: &[&[(GrammarNonTerminals, u16)]] = &[
            &[
                (GrammarNonTerminals::DeriveDef, 113u16),
                (GrammarNonTerminals::EofDef, 114u16),
                (GrammarNonTerminals::ErrorDef, 115u16),
                (GrammarNonTerminals::GLR, 116u16),
                (GrammarNonTerminals::Grammar, 117u16),
                (GrammarNonTerminals::GrammarLine, 119u16),
                (GrammarNonTerminals::ModulePrefixDef, 120u16),
                (GrammarNonTerminals::ReduceDef, 121u16),
                (GrammarNonTerminals::ReduceType, 122u16),
                (GrammarNonTerminals::Rule, 131u16),
                (GrammarNonTerminals::StartDef, 132u16),
                (GrammarNonTerminals::TokenDef, 133u16),
                (GrammarNonTerminals::TokenTypeDef, 134u16),
                (GrammarNonTerminals::UserDataDef, 135u16),
                (GrammarNonTerminals::_GrammarLine_Plus8, 137u16),
            ],
            &[
            ...
            &[],
            &[(GrammarNonTerminals::Action, 93u16)],
            &[],
            &[],
            &[],
            &[],
            &[
                (GrammarNonTerminals::RustCode, 97u16),
                (GrammarNonTerminals::_TerminalSet6, 22u16),
                (GrammarNonTerminals::__TerminalSet6_Plus7, 23u16),
            ],
            &[],
            ...
            &[],
            &[
                (GrammarNonTerminals::RustCode, 105u16),
                (GrammarNonTerminals::_TerminalSet6, 22u16),
                (GrammarNonTerminals::__TerminalSet6_Plus7, 23u16),
            ],
            &[],
            ...
            &[
                ...
                (GrammarNonTerminals::TokenTypeDef, 134u16),
                (GrammarNonTerminals::UserDataDef, 135u16),
                (GrammarNonTerminals::_GrammarLine_Plus8, 136u16),
            ],
            &[],
            &[],
            &[
                (GrammarNonTerminals::TerminalSet, 128u16),
                (GrammarNonTerminals::TerminalSetOrIdent, 129u16),
            ],
            &[],
            &[(GrammarNonTerminals::_caret_Option2, 125u16)],
            &[
                (GrammarNonTerminals::TerminalSetItem, 46u16),
                (GrammarNonTerminals::_TerminalSetItem_Plus3, 47u16),
                (GrammarNonTerminals::_TerminalSetItem_Star4, 126u16),
            ],
            &[],
            &[],
            &[],
        ...
        const RUSTYLR_RULESET_SHIFTED0_MAP: &[u16] = &[
            ...
            2u16, 2u16, 12u16, 2u16, 2u16, 13u16, 2u16, 14u16, 2u16, 2u16, 2u16, 2u16, 1u16, 2u16,
            2u16, 2u16, 2u16, 2u16, 2u16, 2u16, 1u16, 2u16, 2u16, 1u16, 2u16, 2u16, 1u16, 2u16,
            2u16, 2u16, 2u16, 2u16, 2u16, 2u16, 2u16, 15u16, 2u16, 2u16, 11u16, 2u16, 7u16, 8u16,
            2u16, 2u16, 2u16, 2u16, 2u16, 2u16, 2u16, 2u16, 2u16, 2u16, 2u16, 2u16,
        ];
