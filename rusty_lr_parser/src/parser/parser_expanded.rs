...
impl GrammarContext {
    ...
    fn reduce_Rule_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_RuleType_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_RuleType_1(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        self.__rustylr_generated_stack_2.push({ None });
        Ok(())
    }
    fn reduce_RuleLines_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_RuleLines_1(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut RuleLine = self.__rustylr_generated_stack_4.pop().unwrap();
        self.__rustylr_generated_stack_3.push({ vec![RuleLine] });
        Ok(())
    }
    fn reduce_RuleLine_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce__RustyLRGenerated1_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut A = self.__rustylr_generated_stack_6.pop().unwrap();
        self.__rustylr_generated_stack_5.push({ vec![A] });
        Ok(())
    }
    fn reduce__RustyLRGenerated1_1(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut A = self.__rustylr_generated_stack_6.pop().unwrap();
    ...
    fn reduce__RustyLRGenerated0_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut Ap = self.__rustylr_generated_stack_5.pop().unwrap();
        self.__rustylr_generated_stack_5.push({ Ap });
        Ok(())
    }
    fn reduce__RustyLRGenerated0_1(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        self.__rustylr_generated_stack_5.push({ vec![] });
        Ok(())
    }
    fn reduce_TokenMapped_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut Pattern = self.__rustylr_generated_stack_11.pop().unwrap();
        self.__rustylr_generated_stack_6.push({ (None, Pattern) });
        Ok(())
    }
    fn reduce_TokenMapped_1(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut Pattern = self.__rustylr_generated_stack_11.pop().unwrap();
    ...
    fn reduce_TerminalSetItem_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut ident = self.__rustylr_generated_terminal_stack.pop().unwrap();
    ...
    fn reduce_TerminalSetItem_1(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_TerminalSet_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce__RustyLRGenerated2_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut A = self.__rustylr_generated_terminal_stack.pop().unwrap();
        self.__rustylr_generated_stack_9.push({ Some(A) });
        Ok(())
    }
    fn reduce__RustyLRGenerated2_1(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        self.__rustylr_generated_stack_9.push({ None });
        Ok(())
    }
    fn reduce__RustyLRGenerated4_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut A = self.__rustylr_generated_stack_7.pop().unwrap();
        self.__rustylr_generated_stack_10.push({ vec![A] });
        Ok(())
    }
    fn reduce__RustyLRGenerated4_1(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut A = self.__rustylr_generated_stack_7.pop().unwrap();
    ...
    fn reduce__RustyLRGenerated3_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut Ap = self.__rustylr_generated_stack_10.pop().unwrap();
        self.__rustylr_generated_stack_10.push({ Ap });
        Ok(())
    }
    fn reduce__RustyLRGenerated3_1(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        self.__rustylr_generated_stack_10.push({ vec![] });
        Ok(())
    }
    fn reduce_Pattern_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut ident = self.__rustylr_generated_terminal_stack.pop().unwrap();
    ...
    fn reduce_Pattern_1(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_Pattern_2(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_Pattern_3(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_Pattern_4(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_Pattern_5(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_Action_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_Action_1(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        self.__rustylr_generated_stack_2.push({ None });
        Ok(())
    }
    fn reduce_TokenDef_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut semicolon = self.__rustylr_generated_terminal_stack.pop().unwrap();
    ...
    fn reduce_RustCode_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce__RustyLRGenerated6_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut term = self.__rustylr_generated_terminal_stack.pop().unwrap();
        self.__rustylr_generated_terminal_stack.push(term);
        Ok(())
    }
    fn reduce__RustyLRGenerated6_1(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut term = self.__rustylr_generated_terminal_stack.pop().unwrap();
        self.__rustylr_generated_terminal_stack.push(term);
        Ok(())
    }
    fn reduce__RustyLRGenerated6_2(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut term = self.__rustylr_generated_terminal_stack.pop().unwrap();
        self.__rustylr_generated_terminal_stack.push(term);
        Ok(())
    }
    fn reduce__RustyLRGenerated6_3(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut term = self.__rustylr_generated_terminal_stack.pop().unwrap();
        self.__rustylr_generated_terminal_stack.push(term);
        Ok(())
    }
    fn reduce__RustyLRGenerated6_4(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut term = self.__rustylr_generated_terminal_stack.pop().unwrap();
        self.__rustylr_generated_terminal_stack.push(term);
        Ok(())
    }
    fn reduce__RustyLRGenerated6_5(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut term = self.__rustylr_generated_terminal_stack.pop().unwrap();
        self.__rustylr_generated_terminal_stack.push(term);
        Ok(())
    }
    fn reduce__RustyLRGenerated6_6(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut term = self.__rustylr_generated_terminal_stack.pop().unwrap();
        self.__rustylr_generated_terminal_stack.push(term);
        Ok(())
    }
    fn reduce__RustyLRGenerated6_7(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut term = self.__rustylr_generated_terminal_stack.pop().unwrap();
        self.__rustylr_generated_terminal_stack.push(term);
        Ok(())
    }
    fn reduce__RustyLRGenerated6_8(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut term = self.__rustylr_generated_terminal_stack.pop().unwrap();
        self.__rustylr_generated_terminal_stack.push(term);
        Ok(())
    }
    fn reduce__RustyLRGenerated6_9(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut term = self.__rustylr_generated_terminal_stack.pop().unwrap();
        self.__rustylr_generated_terminal_stack.push(term);
        Ok(())
    }
    fn reduce__RustyLRGenerated6_10(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut term = self.__rustylr_generated_terminal_stack.pop().unwrap();
        self.__rustylr_generated_terminal_stack.push(term);
        Ok(())
    }
    fn reduce__RustyLRGenerated6_11(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut term = self.__rustylr_generated_terminal_stack.pop().unwrap();
        self.__rustylr_generated_terminal_stack.push(term);
        Ok(())
    }
    fn reduce__RustyLRGenerated6_12(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut term = self.__rustylr_generated_terminal_stack.pop().unwrap();
        self.__rustylr_generated_terminal_stack.push(term);
        Ok(())
    }
    fn reduce__RustyLRGenerated6_13(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut term = self.__rustylr_generated_terminal_stack.pop().unwrap();
        self.__rustylr_generated_terminal_stack.push(term);
        Ok(())
    }
    fn reduce__RustyLRGenerated6_14(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut term = self.__rustylr_generated_terminal_stack.pop().unwrap();
        self.__rustylr_generated_terminal_stack.push(term);
        Ok(())
    }
    fn reduce__RustyLRGenerated6_15(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut term = self.__rustylr_generated_terminal_stack.pop().unwrap();
        self.__rustylr_generated_terminal_stack.push(term);
        Ok(())
    }
    fn reduce__RustyLRGenerated6_16(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut term = self.__rustylr_generated_terminal_stack.pop().unwrap();
        self.__rustylr_generated_terminal_stack.push(term);
        Ok(())
    }
    fn reduce__RustyLRGenerated5_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut A = self.__rustylr_generated_terminal_stack.pop().unwrap();
        self.__rustylr_generated_stack_14.push({ vec![A] });
        Ok(())
    }
    fn reduce__RustyLRGenerated5_1(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut A = self.__rustylr_generated_terminal_stack.pop().unwrap();
    ...
    fn reduce_StartDef_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut semicolon = self.__rustylr_generated_terminal_stack.pop().unwrap();
        let mut ident = self.__rustylr_generated_terminal_stack.pop().unwrap();
    ...
    fn reduce_EofDef_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut semicolon = self.__rustylr_generated_terminal_stack.pop().unwrap();
        let mut RustCode = self.__rustylr_generated_stack_13.pop().unwrap();
    ...
    fn reduce_TokenTypeDef_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut semicolon = self.__rustylr_generated_terminal_stack.pop().unwrap();
        let mut RustCode = self.__rustylr_generated_stack_13.pop().unwrap();
    ...
    fn reduce_UserDataDef_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut semicolon = self.__rustylr_generated_terminal_stack.pop().unwrap();
        let mut RustCode = self.__rustylr_generated_stack_13.pop().unwrap();
    ...
    fn reduce_ReduceDef_1(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut semicolon = self.__rustylr_generated_terminal_stack.pop().unwrap();
        let mut TerminalSet = self.__rustylr_generated_stack_8.pop().unwrap();
        let mut reducetype = self.__rustylr_generated_stack_17.pop().unwrap();
    ...
    fn reduce_ErrorDef_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut semicolon = self.__rustylr_generated_terminal_stack.pop().unwrap();
        let mut RustCode = self.__rustylr_generated_stack_13.pop().unwrap();
    ...
    fn reduce_ModulePrefixDef_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut semicolon = self.__rustylr_generated_terminal_stack.pop().unwrap();
        let mut RustCode = self.__rustylr_generated_stack_13.pop().unwrap();
    ...
    fn reduce_DeriveDef_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        let mut semicolon = self.__rustylr_generated_terminal_stack.pop().unwrap();
        let mut RustCode = self.__rustylr_generated_stack_13.pop().unwrap();
    ...
    fn reduce_GrammarLine_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_GrammarLine_1(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_GrammarLine_2(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_GrammarLine_3(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_GrammarLine_4(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_GrammarLine_5(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_GrammarLine_6(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_GrammarLine_7(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_GrammarLine_8(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_GrammarLine_9(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
    ...
    fn reduce_Grammar_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        Ok(())
    }
    fn reduce__RustyLRGenerated7_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        Ok(())
    }
    fn reduce__RustyLRGenerated7_1(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
        Ok(())
    }
    fn reduce_Augmented_0(&mut self, data: &mut GrammarArgs) -> Result<(), String> {
