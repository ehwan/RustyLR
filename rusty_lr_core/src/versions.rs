...
pub const COMPATIBLE_RUSTY_LR_VERSION: Version = (4, 4, 0);

/// The `rustylr` executable version that should emit compatible parser code.
pub const COMPATIBLE_RUSTYLR_VERSION: Version = (1, 35, 0);

/// The internal parser generator version expected by this runtime.
pub const EXPECTED_RUSTY_LR_PARSER_VERSION: Version = (4, 4, 0);
